...
public class MainActivity extends AppCompatActivity {
    ...
    public static InputStream getDrawableInputStream(Context context, int drawableResId) throws IOException {
        ...
        if (drawable instanceof BitmapDrawable) {
            ...
            // Handle vector drawables or other non-bitmap drawables
        ...
        // Use PNG for lossless compression, or JPEG with a quality hint (0-100)
        bitmap.compress(Bitmap.CompressFormat.PNG, 100, pipedOutput);
